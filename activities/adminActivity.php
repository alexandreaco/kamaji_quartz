	 ...
	 class AdminActivity {
		...
		function run() {
	 	...
	 	private function retrieveActiveUsers() {
	 		...
	 		$this->emails = array("email@gmail.com", "email2@gmail.com", "email3@gmail.com");
	 		$this->numActiveUsers = count($this->emails);
	 		
	 		print ($this->numActiveUsers);
